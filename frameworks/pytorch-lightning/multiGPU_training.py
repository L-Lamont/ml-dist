...
parser.add_argument('--lr', type=float, default=2e-4, help='Set the learning rate')
parser.add_argument('--data-dir', default='./data', help='Directory dataset is in')
parser.add_argument('--output-dir', default='./output/default', 
                    help='Specify where to save the current model and log')
parser.add_argument('--dist-strat', default='ddp', 
                    help='Set the pytorch lightning distributed time')
...
class LitMNIST(L.LightningModule):
    def __init__(self, data_dir=args.data_dir, hidden_size=64, learning_rate=args.lr):
        super().__init__()
